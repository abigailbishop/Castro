...
contains
  ...
  subroutine ppm_int_profile(s, s_lo, s_hi, ncomp, n, &
    ...
    real(rt), intent(inout) :: Ip(I_lo(1):I_hi(1),I_lo(2):I_hi(2),I_lo(3):I_hi(3),1:2,1:3, icomp)
    real(rt), intent(inout) :: Im(I_lo(1):I_hi(1),I_lo(2):I_hi(2),I_lo(3):I_hi(3),1:2,1:3, icomp)
